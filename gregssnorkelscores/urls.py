...
urlpatterns = [
    ...
    path('spot/<slug:spot_name_slug>/',views.show_spot, name = 'show_spot'), # getting rid of location_name rn
    path('spot_name/write_review/', views.write_review, name='write_review'),
